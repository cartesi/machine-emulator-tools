...
TOOLCHAIN_TAG="${TOOLCHAIN_TAG:-0.12.0}"
RISCV_ARCH="${RISCV_ARCH:-rv64g}"
...
cargo build -Z build-std=std,core,alloc,panic_abort,proc_macro --target rv64g-cartesi-linux-gnu.json --release
